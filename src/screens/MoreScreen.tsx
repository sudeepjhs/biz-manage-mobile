...
export default function MoreScreen() {
  ...
  const menuItems = [
    ...
    },
    {
      id: 'stock-types',
      title: 'Stock Types',
      subtitle: 'Manage inventory classifications',
      icon: 'shape-outline',
      color: '#0ea5e9',
      onPress: () => navigation.navigate('StockTypes'),
      visible: hasPermission('INVENTORY', 'VIEW'),
    },
    {
      id: 'locations',
      title: 'Locations',
      subtitle: 'Warehouses and storage points',
    ...
    },
    {
      id: 'procurement',
      title: 'Procurement',
      subtitle: 'Shortages, requests, and purchase orders',
    ...
    },
    {
      ...
      subtitle: 'Approve, reject, and post movements',
      icon: 'swap-horizontal-bold',
      color: '#2563eb',
      onPress: () => navigation.navigate('MovementQueue'),
      visible: hasPermission('INVENTORY', 'APPROVE_MOVE') || hasPermission('INVENTORY', 'POST_MOVE'),
    },
    {
      id: 'billing',
      title: 'Billing & Recovery',
      subtitle: 'Invoices, payments, and reminders',
      icon: 'cash-multiple',
      color: '#f59e0b',
    ...
    },
    {
      ...
      subtitle: 'Plan and update employee shifts',
      icon: 'calendar-clock-outline',
      color: '#7c3aed',
      onPress: () => navigation.navigate('ShiftManagement'),
      visible: hasPermission('TIME', 'MANAGE_SHIFTS'),
    },
  ];
