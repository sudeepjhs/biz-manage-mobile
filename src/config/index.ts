...
export const ROLE_PERMISSIONS = {
  ADMIN: {
    INVENTORY: ['VIEW', 'CREATE', 'EDIT', 'DELETE', 'APPROVE', 'PROPOSE_MOVE', 'APPROVE_MOVE', 'POST_MOVE', 'MANAGE_TYPES'],
  ...
  MANAGER: {
    INVENTORY: ['VIEW', 'EDIT', 'APPROVE', 'PROPOSE_MOVE', 'APPROVE_MOVE', 'POST_MOVE'],
